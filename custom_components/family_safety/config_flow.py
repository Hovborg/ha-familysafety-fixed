...
_CONFIGURATION_URL = "https://github.com/pantherale0/ha-familysafety"
_MICROSOFT_LOGIN_URL = (
...
async def validate_input(data: dict[str, Any]) -> dict[str, Any]:
    ...
    if not response_url and not refresh_token:
        raise MissingInput
...
class MissingInput(HomeAssistantError):
    """Error to indicate response_url or refresh_token is required."""
